...
namespace FinanceApp.views
{
    ...
    public partial class PassPage : ContentPage
    {
        ...
        private void NumberButtonClicked(object sender, EventArgs e)
        {
            ...
            Console.WriteLine(passCode); ColorizeCircle();
        }
        public void DeleteSymbol(object sender, EventArgs e)
        {
            if (passCode.Length <= 0) return;
            passCode = passCode.Substring(0, passCode.Length - 1); Console.WriteLine(passCode);
            DeColorizeCircle();
        }
        public void DeleteSymbol()
        {
            if (passCode.Length <= 0) return; passCode = passCode.Substring(0, passCode.Length - 1);
            Console.WriteLine(passCode); DeColorizeCircle();
        }

        public async void ColorizeCircle()
        {
            int circlenumber = passCode.Length; switch (circlenumber)
            {
                case 1:
                    {
                ...
                case 2:
                    {
                        circle2.BackgroundColor = Color.Black; break;
                    }
                case 3:
                    {
        ...
        public void DeColorizeCircle()
        {
            int circlenumber = passCode.Length; switch (circlenumber)
            {
                ...
                case 1:
                    {
                        circle2.BackgroundColor = Color.FromHex("#FFF7EC"); break;
                    }
                case 2:
                    {
                ...
                case 3:
                    {
                        circle4.BackgroundColor = Color.FromHex("#FFF7EC"); break;
                    }
            }
        }
    }
